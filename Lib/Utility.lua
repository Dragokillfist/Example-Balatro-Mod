            ...
            {n = G.UIT.R, config = { minw = G.ROOM.T.w*0.25, padding = 0.05},
                nodes = {
                    create_option_cycle{
                        ...
                        label = localize("example_config_label"), -- the label that shows up next to the option cycle
...
G.FUNCS.ExampleCallback = function(e)
    ...
    local mult_ops = { 10, 20, 30, 40 } -- this is the list of options that will be used in the option cycle, and it will be saved to the config file when the game is closed
